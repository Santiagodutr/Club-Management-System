...
router.post('/admin/refresh-stats', [AdminController, 'refreshStats']).use(middleware.auth()).use(middleware.checkRole('admin'))
router.get('/admin/reportes/resumen', [AdminController, 'reporteResumen']).use(middleware.auth()).use(middleware.checkRole('admin'))
...
router.delete('/api/cotizaciones/:id', [CotizacionController, 'eliminarCotizacion'])
...
router.put('/api/servicios-adicionales/:id', [ServiciosAdicionalesController, 'update']).use(middleware.auth()).use(middleware.checkRole('admin'))
router.delete('/api/servicios-adicionales/:id', [ServiciosAdicionalesController, 'destroy']).use(middleware.auth()).use(middleware.checkRole('admin'))
router.patch('/api/servicios-adicionales/:id/toggle', [ServiciosAdicionalesController, 'toggle']).use(middleware.auth()).use(middleware.checkRole('admin'))
